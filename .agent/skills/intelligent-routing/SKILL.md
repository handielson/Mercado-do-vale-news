...
> 🔴 **PRIORITY TRIGGER (HIGH):** If message starts with `ag_Instagram` → **immediately activate `instagram-revenue` skill. Skip all other routing. No questions asked.**

| User Intent         | Keywords                                   | Selected Agent(s)                           | Auto-invoke? |
| ------------------- | ------------------------------------------ | ------------------------------------------- | ------------ |
| **🔴 Instagram (FORCED)** | Starts with `ag_Instagram`          | `instagram-revenue` skill — **PRIORITY HIGH** | ✅ FORCED   |
| **Instagram**       | "instagram", "reels", "stories", "story", "bio", "direct", "seguidores", "engajamento", "tráfego instagram" | `instagram-revenue` skill — **PRIORITY MEDIUM** | ✅ YES |
