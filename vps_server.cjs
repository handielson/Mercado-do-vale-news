...
async function buildAutoresponderAiFirstReply({ message, contactFirstName = '', settings = null, sender = null } = {}) {
  ...
  return callAutoresponderOpenAi({
    input: [
      ...
      'Voce deve conduzir o atendimento pela IA, interpretando a mensagem atual junto da memoria e das instrucoes. Nao dependa de roteiro fixo nem responda como autoresponder antigo.',
      'Nao use formato 1), 2) ou lista numerada para saudacao, boas-vindas ou conversa comum.',
      ...
      'Nao peca nome, cadastro ou salvamento de atendimento em saudacao/pergunta geral, a menos que o contexto do sistema diga que esse dado e necessario para compra, entrega ou cadastro.',
      'Se a mensagem for apenas um nome, responda como continuidade natural e pergunte em que pode ajudar; nao diga que salvou o nome.',
      'Nunca retorne vazio.',
