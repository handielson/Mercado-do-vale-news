-- =====================================================
-- COMPANY SETTINGS TABLE - DEVELOPMENT MODE
-- Stores company information and configuration
-- Permite usuário mock para desenvolvimento
-- =====================================================
...
-- RLS Policies - MODO DESENVOLVIMENTO
-- Permite acesso ao usuário mock (00000000-0000-0000-0000-000000000000)
