        ...
        <div className="space-y-6">
            <header className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        <h2 className="mt-1 text-2xl font-semibold text-slate-800">Tipo de Conta</h2>
            ...
            <section className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
                <div className="space-y-5">
                    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                        ...
                        <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                            <div>
                                <h3 className="text-2xl font-semibold text-slate-800">{currentPlan.label}</h3>
                    ...
                    {hasPendingRequest && upgradeRequest && (
                        <div className="rounded-2xl border border-blue-200 bg-blue-50 p-5">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-semibold uppercase text-blue-800">Analise em andamento</p>
                    ...
                    {hasRejectedRequest && upgradeRequest && (
                        <div className="rounded-2xl border border-red-200 bg-red-50 p-5">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <p className="text-sm font-semibold uppercase text-red-800">Solicitacao rejeitada</p>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                        <div className="mb-4">
                            ...
                            <h3 className="mt-1 text-lg font-semibold text-slate-800">Escolha uma solicitacao</h3>
                        </div>
                            ...
                            {accountPlans.filter((plan) => plan.id !== 'retail').map((plan) => {
                                ...
                                return (
                                    <article key={plan.id} className="rounded-2xl border border-slate-200 bg-slate-50 p-4">
                                        ...
                                        <h4 className="text-lg font-semibold text-slate-800">{plan.label}</h4>
                ...
                <aside className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm lg:sticky lg:top-6 lg:self-start">
                    ...
                    <h3 className="mt-4 text-lg font-semibold text-slate-800">Como funciona</h3>
