        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-4 mt-6">
                <h3 className="text-sm font-bold text-slate-700 mb-4 flex items-center gap-2">
                    <Building2 size={16} />
                    Página Quem Somos / Sobre a Empresa
                </h3>
                
                <div className="mb-4">
                    <label className="block text-sm font-semibold text-slate-700 mb-1">
                        História da Empresa (Quem Somos)
                    </label>
                    <textarea
                        value={form.aboutUsText || ''}
                        onChange={(e) => onChange({ aboutUsText: e.target.value })}
                        className="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none min-h-[150px]"
                        placeholder="Conte a história da Mercado do Vale, missão, visão, desde 2019..."
                    />
                    <p className="text-xs text-slate-500 mt-1">
                        Este texto aparecerá publicamente na página /quem-somos (Aceita quebras de linha).
                    </p>
                </div>
                
                <div className="mb-4">
                    <label className="block text-sm font-semibold text-slate-700 mb-1">
                        URL da Imagem da Loja / Equipe
                    </label>
                    <input
                        type="url"
                        value={form.aboutUsImageUrl || ''}
                        onChange={(e) => onChange({ aboutUsImageUrl: e.target.value })}
                        className="w-full border border-slate-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none"
                        placeholder="https://exemplo.com/fachada_loja.jpg"
                    />
                    <p className="text-xs text-slate-500 mt-1">
                        Cole o link direto da imagem a ser exibida como banner ou foto da equipe.
                    </p>
                </div>
