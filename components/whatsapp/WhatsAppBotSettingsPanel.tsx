      ...
      <div className="grid gap-4 p-4 lg:grid-cols-[1.5fr_1fr]">
        ...
        <label className="text-xs font-semibold uppercase text-slate-500">
          ...
          <input
            ...
            disabled={loading}
            className="mt-2 h-10 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm font-semibold normal-case text-slate-700 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100 disabled:opacity-60"
          />
