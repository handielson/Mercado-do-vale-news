...
assert.match(displayPage, /DISPLAY_APP_VERSION = 'V1\.07'/, 'display deve mostrar versao visual do aplicativo');
...
assert.match(adminPage, /DISPLAY_APP_VERSION = 'V1\.07'/, 'admin deve mostrar versao visual do app no display cadastrado');
