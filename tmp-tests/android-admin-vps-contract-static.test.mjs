...
assert.match(buildGradle, /versionCode = 61/, 'o APK atualizado deve ter novo versionCode');
assert.match(buildGradle, /versionName = "0\.13\.4"/, 'o APK atualizado deve mostrar a nova versao');
