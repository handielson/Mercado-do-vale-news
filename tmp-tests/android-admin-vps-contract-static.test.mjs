...
assert.match(buildGradle, /versionCode = 58/, 'o APK atualizado deve ter novo versionCode');
assert.match(buildGradle, /versionName = "0\.13\.1"/, 'o APK atualizado deve mostrar a nova versao');
