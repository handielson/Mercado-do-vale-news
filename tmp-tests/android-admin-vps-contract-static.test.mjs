...
assert.match(buildGradle, /versionCode = 62/, 'o APK atualizado deve ter novo versionCode');
assert.match(buildGradle, /versionName = "0\.13\.5"/, 'o APK atualizado deve mostrar a nova versao');
