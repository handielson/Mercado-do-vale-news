...
assert.match(activity, /LabelRenderer\.renderCustomText\(currentCustomLabelText/, 'a previa avulsa deve usar o mesmo bitmap enviado para impressao');
...
assert.match(buildGradle, /versionCode = 42/, 'o APK atualizado deve ter novo versionCode');
assert.match(buildGradle, /versionName = "0\.9\.0"/, 'o APK atualizado deve mostrar a nova versao');
