...
assert.match(buildGradle, /versionCode 105/, 'versionCode deve estar preparado para V1.05');
assert.match(buildGradle, /versionName '1\.05'/, 'versionName deve refletir V1.05');
...
assert.match(mainActivity, /play\.google\.com\/store\/apps\/details/, 'WebView deve abrir link da Play Store fora do display');
