...
assert.match(buildGradle, /versionCode 106/, 'versionCode deve estar preparado para V1.06');
assert.match(buildGradle, /versionName '1\.06'/, 'versionName deve refletir V1.06');
