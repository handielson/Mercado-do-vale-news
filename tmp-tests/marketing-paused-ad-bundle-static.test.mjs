...
assert.match(api, /function confirmsPausedAdDuringReview\(ad\)/);
assert.match(api, /status === 'PAUSED'/);
assert.match(api, /effectiveStatus === 'PENDING_REVIEW'/);
assert.match(api, /Meta documents that an ad created with status=PAUSED/);
