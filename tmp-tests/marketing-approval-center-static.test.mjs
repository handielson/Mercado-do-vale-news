...
assert.match(panel, /Abrir anúncio na Meta/);
assert.match(panel, /Confio nesse anúncio/);
...
assert.match(productionApi, /process\.env\.MARKETING_RUNNER_SECRET \|\| process\.env\.SYNC_SECRET \|\| process\.env\.VPS_SYNC_KEY/);
