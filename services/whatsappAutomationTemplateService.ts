...
export const WHATSAPP_AUTOMATION_TEMPLATE_DEFAULTS: WhatsAppAutomationTemplate[] = [
  ...
  },
  {
    ...
    description: 'Enviado uma unica vez ao cliente depois que a compra online e registrada.',
    enabled: true,
    variables: ['nome', 'pedido', 'situacao', 'data', 'itens', 'pagamento', 'situacao_pagamento', 'subtotal', 'desconto', 'frete', 'total', 'tipo_entrega', 'endereco_entrega', 'link_pedido'],
    content: [
      '🛒 Pedido recebido!',
      '',
  ...
  },
  {
    ...
    description: 'Enviado ao cliente quando a equipe altera a situacao de um pedido online.',
    enabled: true,
    variables: ['nome', 'pedido', 'situacao', 'data', 'total', 'link_pedido'],
    content: [
