...
export const ProductCombosPage: React.FC = () => {
  ...
  const loadData = async () => {
    setLoading(true);
    try {
      const prods = await vpsApiService.getProducts({ noCache: true });
      if (prods) {
            ...
            <div className="p-6 space-y-8">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-200">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  <div>
                    <label className="block text-xs font-semibold text-slate-500 uppercase mb-1">Custo (Centavos)</label>
                    <input
                      type="number"
                      value={editingCombo.price_cost}
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={editingCombo.price_retail}
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={editingCombo.price_reseller}
                  ...
                  <div>
                    ...
                    <input
                      type="number"
                      value={editingCombo.price_wholesale}
