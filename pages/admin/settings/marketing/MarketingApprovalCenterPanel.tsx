...
const FIELD_LABELS: Record<string, string> = {
    ...
    delivery: 'Estado de veiculação',
    effect: 'Efeito financeiro',
    maximum: 'Impacto financeiro máximo',
    activeAdCount: 'Anúncios em veiculação',
    metaReview: 'Situação da análise Meta',
    campaignStatus: 'Estado da campanha',
    adsetStatus: 'Estado do conjunto',
    adStatus: 'Estado do anúncio',
