                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div className="flex gap-3">
                            ...
                            <div className="text-sm text-blue-900">
                                <p className="font-medium mb-1">Sobre as Configurações de Documentos</p>
                                <p className="text-blue-700">
                                    Estas configurações afetam todos os documentos gerados pelo sistema, incluindo recibos de venda,
                                    termos de garantia e outros documentos fiscais. As alterações serão aplicadas imediatamente
                                    após salvar.
                                </p>
                            </div>
                        </div>
