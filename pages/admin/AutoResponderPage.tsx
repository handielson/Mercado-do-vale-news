...
const AutoResponderPage: React.FC = () => {
    ...
    const conversationEditorSteps = [
        ...
        {
            id: 'delivery-ask-cep',
            title: 'Pergunta de CEP fora da compra',
            subtitle: 'Quando o cliente pergunta se fazemos entrega',
            customerLabel: 'Cliente pode dizer',
            customerText: 'faz entrega?, entrega em Petrolina?',
            botLabel: 'Bot pergunta',
            messageKey: 'delivery.ask_cep',
            rows: 2,
        },
        {
            id: 'delivery-cep-not-found',
            title: 'CEP nao encontrado',
            subtitle: 'Quando a consulta de CEP nao retorna endereco confiavel',
            customerLabel: 'Cliente informou',
            customerText: 'CEP inexistente ou incompleto',
            botLabel: 'Bot responde',
            messageKey: 'delivery.cep_not_found',
            rows: 2,
        },
        {
            id: 'delivery-cep-found-no-rule',
            title: 'CEP sem regra de frete',
            subtitle: 'Quando o endereco existe, mas nao ha regra automatica cadastrada',
            customerLabel: 'Cliente informou',
            customerText: 'CEP fora das regras de frete',
            botLabel: 'Bot responde',
            messageKey: 'delivery.cep_found_no_rule',
            rows: 3,
        },
        {
            id: 'delivery-choose-product-after-cep',
            title: 'Produto depois do CEP',
            subtitle: 'Quando o cliente consultou entrega antes de escolher produto',
            customerLabel: 'Cliente ja informou',
            customerText: 'CEP valido fora do fluxo de compra',
            botLabel: 'Bot orienta',
            messageKey: 'delivery.choose_product_after_cep',
            rows: 2,
        },
        {
            id: 'product-search-choice-prompt',
            title: 'Escolha em busca de produto',
            subtitle: 'Rodape depois de listar opcoes encontradas',
            customerLabel: 'Cliente buscou',
            customerText: 'redmi note 15',
            botLabel: 'Bot orienta',
            messageKey: 'product_search.choice_prompt',
            rows: 2,
        },
        {
            id: 'product-search-more-prompt',
            title: 'Mais opcoes de produto',
            subtitle: 'Quando ainda ha produtos paginados para mostrar',
            customerLabel: 'Cliente pode dizer',
            customerText: 'mais',
            botLabel: 'Bot orienta',
            messageKey: 'product_search.more_prompt',
            rows: 2,
        },
        {
        ...
        },
        {
            ...
            subtitle: 'Quando nao ha fluxo, regra, intencao, produto ou IA confiavel',
            customerLabel: 'Cliente disse',
            customerText: 'mensagem solta sem contexto',
            botLabel: 'Bot responde',
            messageKey: 'fallback.global',
            rows: 3,
        },
        {
            id: 'fallback-delivery-cep',
            title: 'Fallback de CEP',
            subtitle: 'Quando o fluxo espera CEP e o cliente responde outra coisa',
            customerLabel: 'Cliente respondeu',
            customerText: 'nao sei, pode ser?',
            botLabel: 'Bot responde',
            messageKey: 'fallback.delivery_awaiting_cep',
            rows: 2,
        },
        {
            id: 'fallback-product-choice',
            title: 'Fallback de escolha de produto',
            subtitle: 'Quando o fluxo espera numero, nome ou mais opcoes',
            customerLabel: 'Cliente respondeu',
            customerText: 'qualquer texto fora da lista',
            botLabel: 'Bot responde',
            messageKey: 'fallback.product_choice',
            rows: 2,
        },
        {
            id: 'fallback-purchase-action',
            title: 'Fallback de acao de compra',
            subtitle: 'Quando o produto ja foi escolhido e o bot espera comprar ou detalhes',
            customerLabel: 'Cliente respondeu',
            customerText: 'texto fora de comprar/detalhes',
            botLabel: 'Bot responde',
            messageKey: 'fallback.purchase_action',
            rows: 2,
        },
        {
            id: 'fallback-purchase-variation',
            title: 'Fallback de variacao',
            subtitle: 'Quando o fluxo espera cor, memoria ou opcao numerada',
            customerLabel: 'Cliente respondeu',
            customerText: 'variacao fora da lista',
            botLabel: 'Bot responde',
            messageKey: 'fallback.purchase_variation',
            rows: 2,
        },
        {
            id: 'fallback-purchase-quantity',
            title: 'Fallback de quantidade',
            subtitle: 'Quando o fluxo espera quantidade numerica',
            customerLabel: 'Cliente respondeu',
            customerText: 'quero, pode ser',
            botLabel: 'Bot responde',
            messageKey: 'fallback.purchase_quantity',
            rows: 2,
        },
        {
            id: 'fallback-purchase-item-added',
            title: 'Fallback de item no carrinho',
            subtitle: 'Quando o cliente precisa finalizar, adicionar ou remover',
            customerLabel: 'Cliente respondeu',
            customerText: 'texto fora das opcoes',
            botLabel: 'Bot responde',
            messageKey: 'fallback.purchase_item_added',
            rows: 2,
        },
        {
            id: 'fallback-purchase-fulfillment',
            title: 'Fallback de entrega ou retirada',
            subtitle: 'Quando o fluxo espera a forma de recebimento',
            customerLabel: 'Cliente respondeu',
            customerText: 'nao sei, tanto faz',
            botLabel: 'Bot responde',
            messageKey: 'fallback.purchase_fulfillment',
            rows: 2,
        },
        {
            id: 'fallback-delivery-number',
            title: 'Fallback de numero da entrega',
            subtitle: 'Quando o endereco precisa de numero ou complemento',
            customerLabel: 'Cliente respondeu',
            customerText: 'texto sem numero',
            botLabel: 'Bot responde',
            messageKey: 'fallback.delivery_awaiting_number',
            rows: 2,
        },
        {
            id: 'fallback-payment-method',
            title: 'Fallback de pagamento',
            subtitle: 'Quando o fluxo espera Pix, dinheiro, debito ou cartao',
            customerLabel: 'Cliente respondeu',
            customerText: 'qualquer forma nao reconhecida',
            botLabel: 'Bot responde',
            messageKey: 'fallback.payment_method',
            rows: 2,
        },
        {
            id: 'fallback-customer-name',
            title: 'Fallback de nome',
            subtitle: 'Quando o cadastro precisa de nome completo',
            customerLabel: 'Cliente respondeu',
            customerText: 'nome muito curto',
            botLabel: 'Bot responde',
            messageKey: 'fallback.customer_name',
            rows: 2,
        },
        {
            id: 'fallback-customer-document',
            title: 'Fallback de documento',
            subtitle: 'Quando o cadastro precisa de CPF ou CNPJ',
            customerLabel: 'Cliente respondeu',
            customerText: 'documento invalido',
            botLabel: 'Bot responde',
            messageKey: 'fallback.customer_document',
            rows: 2,
        },
        {
            id: 'fallback-handoff-ready',
            title: 'Fallback de handoff',
            subtitle: 'Quando o pedido ja esta pronto para atendimento humano',
            customerLabel: 'Cliente respondeu',
            customerText: 'qualquer mensagem apos resumo',
            botLabel: 'Bot responde',
            messageKey: 'fallback.handoff_ready',
            rows: 2,
        },
    ];
