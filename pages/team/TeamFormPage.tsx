...
import TeamFinancialSection from '../../components/team/TeamFinancialSection';
import TeamDeliveryHistoryTab from '../../components/team/TeamDeliveryHistoryTab';
...
export default function TeamFormPage() {
    ...
    const [activeTab, setActiveTab] = useState<'form' | 'deliveries'>('form');
            ...
            {isEditing && (
                <div className="flex gap-1 mb-6 bg-slate-100 rounded-lg p-1">
                    ...
                    <button
                        ...
                        className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${activeTab === 'deliveries'
                            ? 'bg-white text-slate-900 shadow-sm'
                            : 'text-slate-600 hover:text-slate-900'
                            }`}
                    >
