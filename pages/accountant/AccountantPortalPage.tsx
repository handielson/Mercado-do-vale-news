...
const reviewLabel: Record<string, string> = {
  ...
  operational_pending_with_document: 'Pedido pendente com nota autorizada',
  cancelled_with_document: 'Pedido cancelado com nota autorizada',
};
