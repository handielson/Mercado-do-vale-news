...
7. Correção de modelo Poco sem a palavra Poco
   - Mensagens: `["Valor do m6pro", "M7 pro"]`
   - Esperado: `m6pro` é tratado como modelo de smartphone; se não estiver no estoque, envia a lista atual sem ativar handoff. `M7 pro` retorna o cartão oficial do Poco M7 Pró 5G.
   - `capa para M7 pro` continua sendo busca de acessório e não pode abrir a lista de smartphones.

8. Entrega fora de compra com DDD local
...
9. Fluxo de compra de smartphone com entrega
...
10. Troca de CEP dentro da compra
...
11. Fluxo de compra com retirada e pagamento
