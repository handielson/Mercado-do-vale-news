...
- [ ] D06b — Espaço do Contador separado do painel administrativo, com concessão por conta e empresa, formulário D06, auditoria e visão de faturamento operacional/fiscal. Implementação local inclui importação idempotente de NF-e/NFC-e autorizadas do Bling para a base própria, sem alterar o Bling e sem chamar pendência de “sem nota”. Testes locais concluídos em E38; pendente aplicar a migration 022, publicar site/API, importar o histórico por períodos, conceder uma conta real e validar isolamento, persistência e relatório com o contador.
