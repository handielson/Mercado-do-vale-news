...
- [ ] D06b.3 — Notas emitidas no período com pedido Shopee/TikTok criado em outro dia exibem o vínculo na fila de conferência, com a data do pedido, sem somá-lo ao faturamento operacional do período (E50). Teste sintético de pedido em 21/09 e NF-e em 22/09 aprovado; falta validação autenticada após publicação.
- [ ] D06b.4 — Conferir documentalmente com o contador as diferenças de R$ 2,00 (Shopee `260923S8DHQDU6`, NF-e 000699) e -R$ 1,93 (Shopee `260922N18QBRPP`, NF-e 000693), inclusive frete, desconto e composição da nota. Responsável: operador e contador. Evidência inicial E47/E49; não inferir tributo nem alterar valores antes da conferência.
