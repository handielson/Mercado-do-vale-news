...
- [ ] F01d — Preparar e aplicar migration em ambiente de homologação, validar a página com sessão operacional e publicar/ativar o cadastro fiscal. Ver roteiro `docs/migracao-bling/cadastro-fiscal.md`. Preflight E20 mostrou `main` 4 commits à frente e 26 atrás de `origin/main`, com mudanças alheias; isolar e reconciliar antes de qualquer publicação.
