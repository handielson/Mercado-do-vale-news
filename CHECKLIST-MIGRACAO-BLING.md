...
- [ ] D06b.4c — Confrontar o cancelamento atual do pedido Shopee `260923S8DHQDU6` com a situação da NF-e 000699 na fonte fiscal competente. A Shopee agora devolve `CANCELLED` e o Bling ainda lista a NF-e como autorizada; confirmar se há evento fiscal de cancelamento, devolução ou outra providência antes de qualquer mutação. Responsável: operador e contador. E51.
- [x] D06b.4d — Disponibilizar no Espaço do Contador consulta somente de leitura do protocolo da NF-e na SEFAZ-PE, com A1 da empresa selecionada, conferência da chave e permissão por empresa. Testes sintéticos e publicação em E52. A resposta da consulta não altera o documento importado nem decide o tratamento fiscal; D06b.4c depende da consulta real e avaliação do contador.
