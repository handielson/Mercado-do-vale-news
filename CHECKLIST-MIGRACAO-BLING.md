...
- [ ] D06b — Espaço do Contador separado do painel administrativo, com concessão por conta e empresa, formulário D06, auditoria e visão de faturamento operacional/fiscal. Migration 022 e site/API publicados em E39; rotas protegidas e tabelas conferidas. Falta cadastrar/conceder uma conta real, importar o histórico Bling por períodos e validar isolamento, persistência e relatório com o contador.
